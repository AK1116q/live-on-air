...
- The popup UI is checked for adding Bilibili and Douyu rooms through the custom platform picker, settings updates, manual polling, stable popup width, hidden horizontal overflow, rounded outer frame, internal scrolling, and responsive layout.
