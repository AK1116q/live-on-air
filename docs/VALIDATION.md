...
- The popup UI is checked for adding Bilibili and Douyu rooms, settings updates, manual polling, stable popup width, hidden horizontal overflow, rounded outer frame, internal scrolling, and responsive layout.
